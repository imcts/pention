				...
				<div style="height: 45px; background-repeat: no-repeat; background-image: url('../../../resources/menuimage/areaBackGraund.jpg');">
					...
					<c:choose>
						<c:when test="${bean.areaSerchKey eq menu.topkey }">
							<a href="#" onclick="areaGoBack('${menu.topkey}','${bean.serviceKey }')"><img border="0" src="../../../resources/menuimage/areasubmenu/${menu.topkey }c.gif"></a>
						</c:when>
						<c:otherwise>
							<a href="#" onclick="areaGoBack('${menu.topkey}','${bean.serviceKey }')"><img border="0" src="../../../resources/menuimage/areasubmenu/${menu.topkey }.gif"></a>
						</c:otherwise>
					</c:choose>
					</div>
