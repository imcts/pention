...
<table width="87%" align="center">
	...
	<tr>
		...
		<td align="left"><input type="text" name="ftitle" maxlength="15" size="80px"/></td>
	</tr> 
	...
	<tr>
	    <td colspan="4">
             <textarea rows="10" name="fcontent"  style="width: 99%" ></textarea>               
        </td>	
	</tr>
    ...
    <tr align="center">
    	...
    	<td colspan="4" align="right">
    		<a href="#" onclick="freewrite('${logchk.id}',${bean.fpage })"><img src="../../../${bean.resource }/btn/complete.png"></a>
