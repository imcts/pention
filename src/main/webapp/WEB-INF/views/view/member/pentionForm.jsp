...
<body>
	<table border="0" align="center" width="100%">
			<tr>
				<td colspan="2">
					<img src="../../../resources/menuimage/InsertPentionNow.jpg">
				</td>
			</tr>
			...
			<tr>
				...
				<td align="center" width="50%"><font color="#510000" face="dothum" style="font-weight:bold; font-size:8pt;"><input type="text" name="pentionName"></font></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="center" width="50%"><font color="#510000" face="dothum" style="font-weight:bold; font-size:8pt;"><ct:choiceAddress/></font></td>
			</tr>
			<tr>
				<td colspan="2"><img src="../../../resources/menuimage/jakdagiya.jpg"></td>
			</tr>
			...
			<tr>
				...
				<td align="center" width="50%"><font color="#510000" face="dothum" style="font-weight:bold; font-size:8pt;"><input type="text" name="address2"></font></td>
			</tr>
			<tr>
				<td colspan="2"><img src="../../../resources/menuimage/jakdagiya.jpg"></td>
			</tr>
			...
			<tr>
				...
				<td align="center" width="50%">
					<font color="#510000" face="dothum" style="font-weight:bold; font-size:8pt;">
						<textarea style="width:400px;"  rows="20" cols="15" name="content"></textarea>
					</font>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center" height="80px">
					<a href="javascript:;" onclick="insertPentionAll()"><img  border="0"  src="../../../resources/menuimage/pentionInputButton.png"></a>
				</td>
			</tr>
