...
<table border="0" width="100%">
	<tr>
		<td>
			<img src="../resources/menuimage/RoomInTopView.jpg">
		</td>
	</tr>
	...
	<tr>
		<td align="center">
			<div id="large">
				<img src="../resources/menuimage/pentionimage/${popup.getFirstRoomPhoto() }">
			</div>
		</td>
	</tr>
	...
	<div align="center" class="small">
				<c:forEach items="${popup.getAllRoomPhoto() }" var="sub">
